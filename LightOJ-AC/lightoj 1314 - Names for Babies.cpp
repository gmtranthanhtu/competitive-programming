/*
  Name: LightOJ 1314 - Names for Babies
  Author: 3T - mailto: gm.tranthanhtu@gmail.com
  Date: 3/4/2013
  Algorithm: suffix array, number of distinct substrings (limited length)
  Time Limit: 4.000s
*/
...
int t, n, p, q, tmpsa[MAXN], sa[MAXN], ra[MAXN], tmpra[MAXN], c[MAXN], plcp[MAXN], phi[MAXN], lcp[MAXN], f[MAXN];
char T[MAXN];
