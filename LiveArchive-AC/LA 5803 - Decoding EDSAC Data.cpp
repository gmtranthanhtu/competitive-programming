/*
  Name: LA 5803 - Decoding EDSAC Data
  Author: 3T - mailto: gm.tranthanhtu@gmail.com
  Date: 14/12/2012
  Algorithm: binary number, ad hoc
  Time Limit: 3.000s
*/
...
int tt, n, t, num;
char c1, c2, line[100], s[] = "PQWERTYUIOJ#SZK*?F@D!HNM&LXGABCV";
ld ans, pow2[20];
...
int main () {
    ...
    fr(i, 1, n){
		...
		string code = getCode();
		ans = 0;
		rep(i, 17) if(code[i] == '1') ans += pow2[i];
